...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      ...
      // Um alvo (botão/link) que foi removido do DOM enquanto o mouse
      // ainda estava em cima dele nunca dispara `mouseleave` — não é
      // que o mouse "saiu", o elemento foi destruído debaixo dele (ex.:
      // um botão de fechar/play que desmonta no clique). Sem isso, o
      // cursor ficava travado nas bordas de um elemento que não existe
      // mais. O ticker já roda a cada frame enquanto há um alvo ativo,
      // então é o lugar certo pra checar se ele ainda está mesmo lá.
